...
static void G_SayTo(const gentity_t* ent, const gentity_t* other, int mode, int color, const char* name, const char* message,
	char* locMsg)
{
	if (!other)
	{
...
qboolean G_VoteMap(const gentity_t* ent, int numArgs, const char* arg1, const char* arg2)
{
