...
#endif //MEMDEBUG
{
	...
	unsigned long int* memid = static_cast<unsigned long*>(ptr);
	*memid = MEM_ID;
	return (unsigned long int*) (static_cast<char*>(ptr) + sizeof(qmax_align_t));
...
void FreeMemory(void* ptr)
{
	unsigned long int* memid = (unsigned long int*)(static_cast<char*>(ptr) - sizeof(qmax_align_t));
