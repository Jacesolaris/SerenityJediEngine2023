...
token_t* PC_CopyToken(token_t* token)
{
	...
	token_t* t = static_cast<token_t*>(GetMemory(sizeof(token_t)));
	//	t = freetokens;
	if (!t)
	{
#ifdef BSPC
...
void PC_AddBuiltinDefines(source_t* source)
{
	...
	{
		define_t* define = static_cast<define_t*>(GetMemory(sizeof(define_t)));
...
define_t* PC_CopyDefine(source_t* source, define_t* define)
{
	...
	define_t* newdefine = static_cast<define_t*>(GetMemory(sizeof(define_t)));
...
source_t* LoadSourceMemory(char* ptr, int length, char* name)
{
	...
	source_t* source = static_cast<source_t*>(GetMemory(sizeof(source_t)));
	Com_Memset(source, 0, sizeof(source_t));
