...
weaponconfig_t* LoadWeaponConfig(char* filename)
{
	...
	weaponconfig_t* wc = static_cast<weaponconfig_t*>(GetClearedHunkMemory(sizeof(weaponconfig_t) +
...
int* WeaponWeightIndex(weightconfig_t* wwc, weaponconfig_t* wc)
{
	...
	int* index = static_cast<int*>(GetClearedMemory(sizeof(int) * wc->numweapons));
