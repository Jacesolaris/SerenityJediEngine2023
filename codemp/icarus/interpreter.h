...
public:
	...
	static keywordArray_t* GetSymbols(void) { return (keywordArray_t*)&m_symbolKeywords; }	//Returns the interpreter's symbol table
	static keywordArray_t* GetIDs(void) { return (keywordArray_t*)&m_IDKeywords; }	//Returns the interpreter's ID table
	static keywordArray_t* GetTypes(void) { return (keywordArray_t*)&m_typeKeywords; }		//Returns the interpreter's type table
