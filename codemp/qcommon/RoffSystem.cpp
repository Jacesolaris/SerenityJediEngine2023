...
{
	TROFFList::iterator itr = mROFFList.find(id);
...
{
	const TROFFList::iterator itr = mROFFList.find(id);
...
{
	for (TROFFEntList::iterator itr = mROFFEntList.begin(); itr != mROFFEntList.end(); ++itr)
	{
