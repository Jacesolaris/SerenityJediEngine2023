...
constexpr auto FX_GHOUL2_TRACE = 0x00020000;		//use in conjunction with particles - actually do full ghoul2 traces for physics collision against entities with a ghoul2 instance;
//shared FX_SIZE2_RAND (used only with cylinders)
constexpr auto FX_GHOUL2_DECALS = 0x00040000;		//use in conjunction with decals - can project decal as a ghoul2 gore skin object onto ghoul2 models;
