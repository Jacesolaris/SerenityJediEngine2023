...
// ZONE
void* Z_Malloc(const int iSize, const memtag_t eTag, const qboolean bZeroit, const int iAlign) {
...
void Z_MorphMallocTag(void* pvBuffer, const memtag_t eDesiredTag) {
