...
typedef struct refexport_s {
	...
	char* (*G2API_GetSurfaceName)					(CGhoul2Info_v& ghlInfo, int model_index, int surfNumber);
	...
	int					(*G2API_InitGhoul2Model)				(CGhoul2Info_v** ghoul2Ptr, const char* fileName, int model_index, qhandle_t customSkin, qhandle_t customShader, int modelFlags, int lodBias);
	...
	qboolean(*G2API_SetBoneAnglesMatrix)			(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, int flags, qhandle_t* modelList, int blendTime, int currentTime);
