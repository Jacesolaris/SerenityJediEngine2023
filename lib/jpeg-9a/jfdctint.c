	...
	jpeg_fdct_islow(DCTELEM * data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < DCTSIZE; ctr++) {
		const JSAMPROW elemptr = sample_data[ctr] + start_col;
...
jpeg_fdct_2x2(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	 ...
	 */
	 ...
	 /* Row 0 */
	JSAMPROW elemptr = sample_data[0] + start_col;

	const INT32 tmp0 = GETJSAMPLE(elemptr[0]) + GETJSAMPLE(elemptr[1]);
	const INT32 tmp1 = GETJSAMPLE(elemptr[0]) - GETJSAMPLE(elemptr[1]);

	/* Row 1 */
	elemptr = sample_data[1] + start_col;

	const INT32 tmp2 = GETJSAMPLE(elemptr[0]) + GETJSAMPLE(elemptr[1]);
	const INT32 tmp3 = GETJSAMPLE(elemptr[0]) - GETJSAMPLE(elemptr[1]);
...
jpeg_fdct_14x7(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 7; ctr++) {
		...
		tmp1 = GETJSAMPLE(elemptr[1]) + GETJSAMPLE(elemptr[12]);
		tmp2 = GETJSAMPLE(elemptr[2]) + GETJSAMPLE(elemptr[11]);
		INT32 tmp13 = GETJSAMPLE(elemptr[3]) + GETJSAMPLE(elemptr[10]);
		INT32 tmp4 = GETJSAMPLE(elemptr[4]) + GETJSAMPLE(elemptr[9]);
		INT32 tmp5 = GETJSAMPLE(elemptr[5]) + GETJSAMPLE(elemptr[8]);
		INT32 tmp6 = GETJSAMPLE(elemptr[6]) + GETJSAMPLE(elemptr[7]);

		tmp10 = tmp0 + tmp6;
		const INT32 tmp14 = tmp0 - tmp6;
		tmp11 = tmp1 + tmp5;
		const INT32 tmp15 = tmp1 - tmp5;
		tmp12 = tmp2 + tmp4;
		const INT32 tmp16 = tmp2 - tmp4;
	...
	for (ctr = DCTSIZE - 1; ctr >= 0; ctr--) {
		...
		z1 -= tmp3;
		z1 = MULTIPLY(z1, FIX(0.461784020));                /* (c2+c6-c4)/2 */
		INT32 z2 = MULTIPLY(tmp0 - tmp2, FIX(1.202428084));       /* (c2+c4-c6)/2 */
		const INT32 z3 = MULTIPLY(tmp1 - tmp2, FIX(0.411026446));       /* c6 */
...
jpeg_fdct_12x6(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 6; ctr++) {
		...
		tmp1 = GETJSAMPLE(elemptr[1]) + GETJSAMPLE(elemptr[10]);
		tmp2 = GETJSAMPLE(elemptr[2]) + GETJSAMPLE(elemptr[9]);
		INT32 tmp3 = GETJSAMPLE(elemptr[3]) + GETJSAMPLE(elemptr[8]);
		INT32 tmp4 = GETJSAMPLE(elemptr[4]) + GETJSAMPLE(elemptr[7]);
		INT32 tmp5 = GETJSAMPLE(elemptr[5]) + GETJSAMPLE(elemptr[6]);

		tmp10 = tmp0 + tmp5;
		INT32 tmp13 = tmp0 - tmp5;
		tmp11 = tmp1 + tmp4;
		INT32 tmp14 = tmp1 - tmp4;
		tmp12 = tmp2 + tmp3;
		INT32 tmp15 = tmp2 - tmp3;
...
jpeg_fdct_10x5(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 5; ctr++) {
		...
		tmp0 = GETJSAMPLE(elemptr[0]) + GETJSAMPLE(elemptr[9]);
		tmp1 = GETJSAMPLE(elemptr[1]) + GETJSAMPLE(elemptr[8]);
		INT32 tmp12 = GETJSAMPLE(elemptr[2]) + GETJSAMPLE(elemptr[7]);
		INT32 tmp3 = GETJSAMPLE(elemptr[3]) + GETJSAMPLE(elemptr[6]);
		INT32 tmp4 = GETJSAMPLE(elemptr[4]) + GETJSAMPLE(elemptr[5]);

		tmp10 = tmp0 + tmp4;
		INT32 tmp13 = tmp0 - tmp4;
		tmp11 = tmp1 + tmp3;
		const INT32 tmp14 = tmp1 - tmp3;
...
jpeg_fdct_8x4(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 4; ctr++) {
		...
		tmp0 = GETJSAMPLE(elemptr[0]) + GETJSAMPLE(elemptr[7]);
		tmp1 = GETJSAMPLE(elemptr[1]) + GETJSAMPLE(elemptr[6]);
		INT32 tmp2 = GETJSAMPLE(elemptr[2]) + GETJSAMPLE(elemptr[5]);
		INT32 tmp3 = GETJSAMPLE(elemptr[3]) + GETJSAMPLE(elemptr[4]);

		tmp10 = tmp0 + tmp3;
		INT32 tmp12 = tmp0 - tmp3;
		tmp11 = tmp1 + tmp2;
		INT32 tmp13 = tmp1 - tmp2;
		...
		INT32 z1 = MULTIPLY(tmp12 + tmp13, FIX_0_541196100);       /* c6 */
		/* Add fudge factor here for final descale. */
...
jpeg_fdct_6x3(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 3; ctr++) {
		...
		tmp0 = GETJSAMPLE(elemptr[0]) + GETJSAMPLE(elemptr[5]);
		const INT32 tmp11 = GETJSAMPLE(elemptr[1]) + GETJSAMPLE(elemptr[4]);
		tmp2 = GETJSAMPLE(elemptr[2]) + GETJSAMPLE(elemptr[3]);

		INT32 tmp10 = tmp0 + tmp2;
		const INT32 tmp12 = tmp0 - tmp2;
...
jpeg_fdct_4x2(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 2; ctr++) {
		...
		const INT32 tmp10 = GETJSAMPLE(elemptr[0]) - GETJSAMPLE(elemptr[3]);
		const INT32 tmp11 = GETJSAMPLE(elemptr[1]) - GETJSAMPLE(elemptr[2]);
...
jpeg_fdct_2x1(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	const JSAMPROW elemptr = sample_data[0] + start_col;

	const INT32 tmp0 = GETJSAMPLE(elemptr[0]);
	const INT32 tmp1 = GETJSAMPLE(elemptr[1]);
...
jpeg_fdct_7x14(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (;;) {
		...
		z1 -= tmp3;
		z1 = MULTIPLY(z1, FIX(0.353553391));                /* (c2+c6-c4)/2 */
		INT32 z2 = MULTIPLY(tmp0 - tmp2, FIX(0.920609002));       /* (c2+c4-c6)/2 */
		const INT32 z3 = MULTIPLY(tmp1 - tmp2, FIX(0.314692123));       /* c6 */
		dataptr[2] = (DCTELEM)DESCALE(z1 + z2 + z3, CONST_BITS - PASS1_BITS);
		z1 -= z2;
		z2 = MULTIPLY(tmp0 - tmp1, FIX(0.881747734));       /* c4 */
		dataptr[4] = (DCTELEM)
	...
	for (ctr = 0; ctr < 7; ctr++) {
		...
		tmp1 = dataptr[DCTSIZE * 1] + wsptr[DCTSIZE * 4];
		tmp2 = dataptr[DCTSIZE * 2] + wsptr[DCTSIZE * 3];
		INT32 tmp13 = dataptr[DCTSIZE * 3] + wsptr[DCTSIZE * 2];
		INT32 tmp4 = dataptr[DCTSIZE * 4] + wsptr[DCTSIZE * 1];
		INT32 tmp5 = dataptr[DCTSIZE * 5] + wsptr[DCTSIZE * 0];
		INT32 tmp6 = dataptr[DCTSIZE * 6] + dataptr[DCTSIZE * 7];
...
jpeg_fdct_6x12(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 6; ctr++) {
		...
		tmp1 = dataptr[DCTSIZE * 1] + wsptr[DCTSIZE * 2];
		tmp2 = dataptr[DCTSIZE * 2] + wsptr[DCTSIZE * 1];
		INT32 tmp3 = dataptr[DCTSIZE * 3] + wsptr[DCTSIZE * 0];
		INT32 tmp4 = dataptr[DCTSIZE * 4] + dataptr[DCTSIZE * 7];
		INT32 tmp5 = dataptr[DCTSIZE * 5] + dataptr[DCTSIZE * 6];
...
jpeg_fdct_5x10(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 5; ctr++) {
		...
		tmp0 = dataptr[DCTSIZE * 0] + wsptr[DCTSIZE * 1];
		tmp1 = dataptr[DCTSIZE * 1] + wsptr[DCTSIZE * 0];
		INT32 tmp12 = dataptr[DCTSIZE * 2] + dataptr[DCTSIZE * 7];
		INT32 tmp3 = dataptr[DCTSIZE * 3] + dataptr[DCTSIZE * 6];
		INT32 tmp4 = dataptr[DCTSIZE * 4] + dataptr[DCTSIZE * 5];
...
jpeg_fdct_4x8(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 4; ctr++) {
		...
		tmp0 = dataptr[DCTSIZE * 0] + dataptr[DCTSIZE * 7];
		tmp1 = dataptr[DCTSIZE * 1] + dataptr[DCTSIZE * 6];
		INT32 tmp2 = dataptr[DCTSIZE * 2] + dataptr[DCTSIZE * 5];
		INT32 tmp3 = dataptr[DCTSIZE * 3] + dataptr[DCTSIZE * 4];
...
jpeg_fdct_3x6(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 3; ctr++) {
		...
		tmp0 = dataptr[DCTSIZE * 0] + dataptr[DCTSIZE * 5];
		const INT32 tmp11 = dataptr[DCTSIZE * 1] + dataptr[DCTSIZE * 4];
		tmp2 = dataptr[DCTSIZE * 2] + dataptr[DCTSIZE * 3];
...
jpeg_fdct_2x4(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	for (ctr = 0; ctr < 2; ctr++) {
		...
		const INT32 tmp10 = dataptr[DCTSIZE * 0] - dataptr[DCTSIZE * 3];
		const INT32 tmp11 = dataptr[DCTSIZE * 1] - dataptr[DCTSIZE * 2];
...
jpeg_fdct_1x2(DCTELEM* data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
	...
	const INT32 tmp0 = GETJSAMPLE(sample_data[0][start_col]);
	const INT32 tmp1 = GETJSAMPLE(sample_data[1][start_col]);
