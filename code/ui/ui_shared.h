...
using displayContextDef_t = struct {
	...
	qboolean(*g2_RemoveGhoul2Model)(CGhoul2Info_v& ghlInfo, int model_index);
...
constexpr auto WINDOW_HORIZONTAL = 0x00000400;	// for list boxes and sliders, vertical is default this is set of horizontal;
