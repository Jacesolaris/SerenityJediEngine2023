...
void WP_FireBryarPistolDuals(gentity_t* ent, qboolean altFire, qboolean second_pistol);
void WP_FireBryarPistolold(gentity_t* ent, qboolean altFire);
void WP_FireJawaPistol(gentity_t* ent, qboolean altFire);
void WP_FireBryarsbdPistol(gentity_t* ent, qboolean altFire);
void WP_FireBlasterMissile(gentity_t* ent, vec3_t start, vec3_t dir, qboolean altFire);
void WP_FireBlaster(gentity_t* ent, qboolean altFire);
void WP_FireWristPistol(gentity_t* ent, qboolean altFire);
void WP_BotLaser(gentity_t* ent);
void WP_FireBowcaster(gentity_t* ent, qboolean altFire);
void WP_Concussion(gentity_t* ent, qboolean altFire);
void WP_FireDEMP2(gentity_t* ent, qboolean altFire);
void charge_stick(gentity_t* self, gentity_t* other, const trace_t* trace);
void WP_FireDetPack(gentity_t* ent, qboolean altFire);
...
void WP_PlaceLaserTrap(gentity_t* ent, qboolean altFire);
