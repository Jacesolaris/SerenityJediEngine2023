						...
						WP_SABER && !Q_irand(0, chanceScale)))
				{
						...
						&& (!Q_irand(0, 1) || NPC->s.weapon != WP_SABER))
					{
						...
						/////////////////////  FP_LIGHTNING_STRIKE ////////////////////////////////
							...
							&& Q_irand(0, 1) && NPC->enemy && NPC->enemy->client && NPC->enemy->client->ps.stasisTime < level.time)
						{
	...
	const float dist = 0.0f)
{
	...
	Jedi_CheckJumpEvasionSafety(self, cmd, evasion_type);
	//=======================================================================================
	//stop taunting
	...
	const int parryReCalcTime = Jedi_ReCalcParryTime(self, evasion_type);
