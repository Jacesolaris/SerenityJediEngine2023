...
void PM_SetAnimFinal(int* torsoAnim, int* legsAnim, const int set_anim_parts, int anim, const int set_anim_flags,
                     int* torsoAnimTimer,
                     int* legsAnimTimer, gentity_t* gent, int blend_time) // default blend_time=350
{
