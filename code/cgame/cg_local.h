...
void cgi_R_AddPolyToScene(qhandle_t h_shader, int numVerts, const polyVert_t* verts);
...
void cg_missile_hit_player(const centity_t* cent, int weapon, vec3_t origin, vec3_t dir, qboolean altFire);
void cg_missile_hit_wall(const centity_t* cent, int weapon, vec3_t origin, vec3_t dir, qboolean altFire);
