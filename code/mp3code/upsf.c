                         ...
                         const int gr)
{
	...
	const int block_type = grdat->block_type;
	const int mixed_block_flag = grdat->mixed_block_flag;
	const int scalefac_compress = grdat->scalefac_compress;

	const int slen0 = slen_table[scalefac_compress][0];
	const int slen1 = slen_table[scalefac_compress][1];
