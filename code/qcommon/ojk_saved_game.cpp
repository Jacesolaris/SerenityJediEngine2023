...
namespace ojk
{
		...
		Buffer& dst_buffer)
	{
		...
		while (src_count < src_size)
		{
			...
			const uint8_t b = src_buffer[src_index++];
			...
			if (src_index - src_count == 1)
			{
				while (src_index < src_size &&
					src_index - src_count < 127 && (
						src_buffer[src_index] != src_buffer[src_index - 1] || src_index > 1 &&
		...
		const std::string& base_file_name)
	{
		...
		if (com_outcast->integer == 0)
		{
			...
			{
				return "Account/Saved-Missions-JediAcademy/" + normalized_file_name + ".sav";
			}
		...
		if (com_outcast->integer == 1)
		{
			...
			{
				return "Account/Saved-Missions-JediOutcast/" + normalized_file_name + ".sav";
			}
		...
		{
			return "Account/Saved-Missions-YAV/" + normalized_file_name + ".sav";
		}
		...
		{
			return "Account/Saved-Missions-SECRET/" + normalized_file_name + ".sav";
		}
		if (com_outcast->integer == 7)
		{
			return "Account/Saved-Missions-NOC/" + normalized_file_name + ".sav";
		}
		if (com_outcast->integer == 8)
		{
			return "Account/Saved-Missions-PIB/" + normalized_file_name + ".sav";
		}
		if (com_outcast->integer == 9)
		{
			return "Account/Saved-Missions-RED/" + normalized_file_name + ".sav";
		}
		if (com_outcast->integer == 10)
		{
			return "Account/Saved-Missions-MD/" + normalized_file_name + ".sav";
		}
		if (!g_newgameplusJKA->integer)
		{
			return "Account/Saved-Missions-JediAcademy/" + normalized_file_name + ".sav";
