...
#else
#define PRODUCT_NAME			"SerenityJediEngine2023-SP"

constexpr auto CLIENT_WINDOW_TITLE = "SerenityJediEngine2023 (SP)";
constexpr auto CLIENT_CONSOLE_TITLE = "SerenityJediEngine2023 Console (SP)";
constexpr auto HOMEPATH_NAME_UNIX = "SerenityJediEngine2023";
constexpr auto HOMEPATH_NAME_WIN = "SJE";
#define HOMEPATH_NAME_MACOSX HOMEPATH_NAME_WIN
#endif

constexpr auto BASEGAME = "base";
constexpr auto OPENJKGAME = "SerenityJediEngine2023";
